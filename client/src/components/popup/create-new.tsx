...
const Create = () => {
  return (
    <div className="border-2 border-gray-700 shadow-md p-1 flex flex-col rounded-md absolute left-[10%] top-[8%] bg-white dark:bg-slate-800  z-10">
      ...
      <div>
        <div className="flex items-center gap-x-4 py-2 p-2 dark:hover:bg-gray-900 hover:bg-gray-200 rounded-md cursor-pointer select-none">
          <img
            className="w-[15%]"
      ...
      <p className="cursor-pointer dark:hover:bg-gray-900 hover:bg-gray-200 p-3 rounded-md">
        View All Projects
      </p>
      <Link
        to={"/create"}
        className="cursor-pointer dark:hover:bg-gray-900 hover:bg-gray-200 p-3 rounded-md"
      >
        Create new project
      </Link>
    </div>
