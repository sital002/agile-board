    ...
    <div className="w-full px-8 overflow-hidden">
      ...
      <div className="flex gap-2 w-full overflow-x-auto	">
        <DragDropContext onDragEnd={dragHandler}>
          {defaultColums.map((colum, index) => {
            return <Column id={index} key={index + colum} title={colum} />;
          })}
        </DragDropContext>
      </div>
    </div>
...
//                     size={30}
//                     className="cursor-pointer dark:bg-gray-900 bg-gray-200 rounded-md p-1"
//                   />
//                   <X
//                     onClick={() => {
//                       setOpen(false);
...
//               size={30}
//               strokeWidth={0.9}
//               className="min-w-[10px] cursor-pointer dark:bg-gray-900 bg-gray-200 rounded-md"
//             />
//           </div>
//         </div>
//       </div>
